...
#define ant_AssignChannelCmd_channel_type_ENUMTYPE ant_AntChannelType
...
#define ant_ChannelEvent_event_ENUMTYPE ant_AntChannelEvent
...
#define ANT_WHAD_PROTOCOL_ANT_ANT_PB_H_MAX_SIZE  ant_Message_size
