...
PB_BIND(ble_ExtAdvPdu, ble_ExtAdvPdu, 2)
...
PB_BIND(ble_SetPhyCmd, ble_SetPhyCmd, AUTO)


PB_BIND(ble_SetSupportedPhysCmd, ble_SetSupportedPhysCmd, AUTO)


PB_BIND(ble_SetTxPowerLevelCmd, ble_SetTxPowerLevelCmd, AUTO)
