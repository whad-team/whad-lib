...
#define generic_CmdResult_result_ENUMTYPE generic_ResultCode




#define generic_Message_msg_result_ENUMTYPE generic_ResultCode
...
#define GENERIC_WHAD_PROTOCOL_GENERIC_PB_H_MAX_SIZE generic_Progress_size
