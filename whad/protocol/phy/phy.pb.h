...
#ifndef PB_PHY_WHAD_PROTOCOL_PHY_PHY_PB_H_INCLUDED
#define PB_PHY_WHAD_PROTOCOL_PHY_PHY_PB_H_INCLUDED
#include <pb.h>
...
#define phy_SetLoRaModulationCmd_spreading_factor_ENUMTYPE phy_LoRaSpreadingFactor
#define phy_SetLoRaModulationCmd_coding_rate_ENUMTYPE phy_LoRaCodingRate




#define phy_SetEndiannessCmd_endianness_ENUMTYPE phy_Endianness

#define phy_SetTXPowerCmd_tx_power_ENUMTYPE phy_TXPower
...
#define phy_JamCmd_mode_ENUMTYPE phy_JammingMode


#define phy_PacketReceived_endian_ENUMTYPE phy_Endianness
#define phy_PacketReceived_modulation_ENUMTYPE phy_Modulation

#define phy_RawPacketReceived_endian_ENUMTYPE phy_Endianness
#define phy_RawPacketReceived_modulation_ENUMTYPE phy_Modulation
...
#define phy_ScheduleSendCmd_init_default         {{0, {0}}, 0}
...
#define phy_ScheduleSendCmd_init_zero            {{0, {0}}, 0}
...
#define PHY_WHAD_PROTOCOL_PHY_PHY_PB_H_MAX_SIZE  phy_PacketReceived_size
...
#define phy_ScheduleSendCmd_size                 269
