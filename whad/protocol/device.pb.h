...
#ifndef PB_DISCOVERY_WHAD_PROTOCOL_DEVICE_PB_H_INCLUDED
#define PB_DISCOVERY_WHAD_PROTOCOL_DEVICE_PB_H_INCLUDED
#include <pb.h>
...
#define DISCOVERY_WHAD_PROTOCOL_DEVICE_PB_H_MAX_SIZE discovery_DeviceDomainInfoResp_size
