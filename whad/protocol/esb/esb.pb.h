...
#ifndef PB_ESB_WHAD_PROTOCOL_ESB_ESB_PB_H_INCLUDED
#define PB_ESB_WHAD_PROTOCOL_ESB_ESB_PB_H_INCLUDED
#include <pb.h>
...
#define ESB_WHAD_PROTOCOL_ESB_ESB_PB_H_MAX_SIZE  esb_Message_size
