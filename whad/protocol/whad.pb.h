...
#ifndef PB_WHAD_PROTOCOL_WHAD_PB_H_INCLUDED
#define PB_WHAD_PROTOCOL_WHAD_PB_H_INCLUDED
#include <pb.h>
#include "whad/protocol/device.pb.h"
#include "whad/protocol/generic.pb.h"
#include "whad/protocol/ble/ble.pb.h"
#include "whad/protocol/dot15d4/dot15d4.pb.h"
#include "whad/protocol/esb/esb.pb.h"
#include "whad/protocol/unifying/unifying.pb.h"
#include "whad/protocol/phy/phy.pb.h"
...
union Message_msg_size_union {char f1[(6 + generic_Message_size)]; char f2[(6 + discovery_Message_size)]; char f3[(6 + ble_Message_size)]; char f7[(6 + phy_Message_size)]; char f0[306];};
#endif
#if defined(generic_Message_size) && defined(discovery_Message_size) && defined(ble_Message_size) && defined(phy_Message_size)
