...
#ifndef PB_UNIFYING_WHAD_PROTOCOL_UNIFYING_UNIFYING_PB_H_INCLUDED
#define PB_UNIFYING_WHAD_PROTOCOL_UNIFYING_UNIFYING_PB_H_INCLUDED
#include <pb.h>
...
#define UNIFYING_WHAD_PROTOCOL_UNIFYING_UNIFYING_PB_H_MAX_SIZE unifying_Message_size
